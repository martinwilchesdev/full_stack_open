...
app.use('/api/notes', notesRouter) // Las rutas definidas en el enrutador se agregan a la URL base /api/notes
...
// La peticion POST realizada a la URL http://localhost:3001/api/notes/1 se capturara por el controlador anteriormente definido
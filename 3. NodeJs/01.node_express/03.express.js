...
// La aplicacion de Express es almacenada a una variable, en este caso `app`
const app = express()
...
app.get('/', (req, res) => {
    /**
     * El controlador de eventos retorna como respuesta un string a la peticion realizada, mediante el metodo `send()`.
...
app.get('/notes', (req, res) => {
    // La ruta del servidor retorna como respuesta un arreglo en formato JSON.
    res.json(notes)
})

/**
 * La funcion del controlador de eventos en ambos casos acepta 2 parametros.
 * - req (request) :: Contiene toda la informacion de la solicitud HTTP realizada al servidor.

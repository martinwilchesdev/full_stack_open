...
const App = () => {
     ...
     * De esta forma el controlador de eventos es una funcion definida con la sintaxis de funcion de flecha.
     * El llamado de la funcion solo ocurre cuando se da clic en el boton y no cuando se renderiza la aplicacion.
    */
